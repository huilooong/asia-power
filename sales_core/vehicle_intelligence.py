...
def vin_reasoning_evidence(vin: str) -> dict[str, Any]:
    """Reuse OCR's ISO-3779 implementation for model-facing failed-VIN evidence."""
...
def enrich_from_vin(
    ...
    *,
    ...
    # Retain raw customer input plus deterministic checksum evidence for the
    # internal reasoning path; public/log rendering remains masked by default.
