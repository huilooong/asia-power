const CACHE_VERSION = 'pwa-app-v1';
...
const STATIC_ASSETS = [
  ...
  '/css/pwa-install.css?v=pwa-app-v1',
  '/css/pwa-app-shell.css?v=pwa-app-v1',
  '/js/path-utils.js',
  ...
  '/js/pwa-install.js?v=pwa-app-v1',
  '/js/pwa-app-shell.js?v=pwa-app-v1',
  '/assets/favicon.png',
