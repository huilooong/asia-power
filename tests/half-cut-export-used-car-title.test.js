...
test('used-car catalog chrome cannot be overwritten with half-cut or truck inquiry copy', () => {
  ...
  assert.match(catalogHtml, /path-utils\.js\?v=site-media-brand-identity-v1-20260822/);
  assert.match(catalogHtml, /components\.js\?v=site-media-brand-identity-v1-20260822/);
});
