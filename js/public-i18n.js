...
(function () {
  ...
  const STRINGS = {
    ...
    'nav.requestQuote': { en: 'Request quote', zh: '获取报价' , fr: 'Demander un devis', ar: 'طلب عرض سعر' },
    'quoteList.metaTitle': { en: 'Quote List | AsiaPower', zh: '询价单 | AsiaPower', fr: 'Liste de devis | AsiaPower', ar: 'قائمة عرض السعر | AsiaPower' },
    'quoteList.title': { en: 'Quote list', zh: '询价单', fr: 'Liste de devis', ar: 'قائمة عرض السعر' },
    'quoteList.lead': { en: 'Add units from product pages, then send one WhatsApp inquiry for the whole list. This is not checkout — our team confirms price and shipping.', zh: '从商品页加入车源，再通过一条 WhatsApp 消息发送整份询价单。这不是在线结账；价格与运输会由团队再次确认。', fr: 'Ajoutez des unités depuis les pages produit, puis envoyez une seule demande WhatsApp pour toute la liste. Il ne s’agit pas d’un paiement en ligne : notre équipe confirme le prix et le transport.', ar: 'أضف الوحدات من صفحات المنتجات ثم أرسل استفسار واتساب واحداً للقائمة كاملة. هذه ليست عملية دفع؛ يؤكد فريقنا السعر والشحن.' },
    'quoteList.whatsapp': { en: 'WhatsApp this list', zh: '通过 WhatsApp 发送询价单', fr: 'Envoyer la liste sur WhatsApp', ar: 'إرسال القائمة عبر واتساب' },
    'quoteList.clear': { en: 'Clear list', zh: '清空询价单', fr: 'Vider la liste', ar: 'مسح القائمة' },
    'quoteList.empty': { en: 'Your quote list is empty. Open a product page and add a unit to request a quote.', zh: '询价单为空。请打开商品页并加入车源以获取报价。', fr: 'Votre liste de devis est vide. Ouvrez une page produit et ajoutez une unité pour demander un devis.', ar: 'قائمة عرض السعر فارغة. افتح صفحة منتج وأضف وحدة لطلب عرض سعر.' },
    'quoteList.unit': { en: 'Unit', zh: '车源', fr: 'Unité', ar: 'الوحدة' },
    'quoteList.qty': { en: 'Qty', zh: '数量', fr: 'Qté', ar: 'الكمية' },
    'quoteList.view': { en: 'View listing', zh: '查看车源', fr: 'Voir l’annonce', ar: 'عرض القائمة' },
    'quoteList.remove': { en: 'Remove', zh: '移除', fr: 'Retirer', ar: 'إزالة' },
    'site.nav.allInventory': { en: 'All inventory', zh: '全部库存', fr: 'Tout le stock', ar: 'كل المخزون' },
    'site.nav.brands': { en: 'Brands', zh: '品牌', fr: 'Marques', ar: 'العلامات التجارية' },
    'site.nav.usedCars': { en: 'Export used cars', zh: '出口二手车', fr: 'Véhicules d’occasion export', ar: 'سيارات مستعملة للتصدير' },
    'site.nav.productsAria': { en: 'Product categories', zh: '产品分类', fr: 'Catégories de produits', ar: 'فئات المنتجات' },
    'site.toolbar.promise': { en: 'Verified evidence where available · EXW pricing clearly marked', zh: '有验证证据时明确展示 · EXW 价格清晰标注', fr: 'Preuves vérifiées lorsqu’elles sont disponibles · Prix EXW clairement indiqués', ar: 'تُعرض أدلة التحقق عند توفرها · أسعار EXW موضحة بوضوح' },
    ...
    'site.footer.blurb': { en: 'A professional vehicle and parts sourcing platform connecting documented inventory with international buyers.', zh: '专业的汽车与零部件采购平台，将有据可查的库存与国际买家连接起来。', fr: 'Une plateforme professionnelle d’approvisionnement en véhicules et pièces, reliant des stocks documentés aux acheteurs internationaux.', ar: 'منصة احترافية لتوريد المركبات وقطع الغيار تربط المخزون الموثق بالمشترين الدوليين.' },
    'site.footer.contactNote': { en: 'Send the stock ID, destination and required quantity. Availability is confirmed before contract.', zh: '请发送库存编号、目的地和所需数量；签约前会再次确认库存。', fr: 'Envoyez le numéro de stock, la destination et la quantité requise. La disponibilité est confirmée avant contrat.', ar: 'أرسل رقم المخزون والوجهة والكمية المطلوبة. يتم تأكيد التوفر قبل التعاقد.' },
    'site.footer.productsAria': { en: 'Product links', zh: '产品链接', fr: 'Liens produits', ar: 'روابط المنتجات' },
    'site.footer.companyAria': { en: 'Company links', zh: '公司链接', fr: 'Liens de l’entreprise', ar: 'روابط الشركة' },
    'site.trust.live.label': { en: 'Live inventory status', zh: '实时库存状态', fr: 'Statut du stock en direct', ar: 'حالة المخزون المباشرة' },
    'site.trust.live.sub': { en: 'Availability is shown from the current listing record', zh: '现货状态来自当前商品记录', fr: 'La disponibilité provient de la fiche actuelle', ar: 'يُعرض التوفر من سجل القائمة الحالي' },
    'site.trust.verified.label': { en: 'Supplier verification', zh: '供应商验证', fr: 'Vérification du fournisseur', ar: 'التحقق من المورد' },
    'site.trust.verified.sub': { en: 'Displayed only when supplier evidence has been reviewed', zh: '仅在供应商证据完成审核后展示', fr: 'Affichée uniquement après examen des preuves du fournisseur', ar: 'تُعرض فقط بعد مراجعة أدلة المورد' },
    'site.trust.exportReview.label': { en: 'Export document review', zh: '出口文件审核', fr: 'Examen des documents d’exportation', ar: 'مراجعة وثائق التصدير' },
    'site.trust.exportReview.sub': { en: 'VIN, mileage and export requirements confirmed before contract and shipment', zh: '签约和发运前确认 VIN、里程及出口要求', fr: 'Le VIN, le kilométrage et les exigences d’exportation sont confirmés avant contrat et expédition', ar: 'يتم تأكيد رقم VIN والمسافة ومتطلبات التصدير قبل التعاقد والشحن' },
    'site.trust.price.label': { en: 'Clear EXW pricing', zh: '清晰的 EXW 价格', fr: 'Prix EXW clairs', ar: 'أسعار EXW واضحة' },
    'site.trust.price.sub': { en: 'Public listing prices identify the EXW basis', zh: '公开价格明确标注 EXW 基础', fr: 'Les prix publics indiquent clairement la base EXW', ar: 'توضح أسعار القوائم العامة أساس EXW' },
    'site.trust.evidence.label': { en: 'Original listing evidence', zh: '原始商品证据', fr: 'Preuves originales de l’annonce', ar: 'أدلة القائمة الأصلية' },
    'site.trust.evidence.sub': { en: 'Original photos are retained; further evidence is available on request', zh: '保留原始图片；可按需提供更多证据', fr: 'Les photos originales sont conservées ; d’autres preuves sont disponibles sur demande', ar: 'يتم الاحتفاظ بالصور الأصلية؛ وتتوفر أدلة إضافية عند الطلب' },
    ...
    'home.v4.hero.badge': { en: 'Supplier evidence shown on verified listings', zh: '已验证车源展示供应商证据', fr: 'Preuves fournisseur affichées sur les annonces vérifiées', ar: 'تُعرض أدلة المورد في القوائم التي تم التحقق منها' },
    'home.v4.hero.title': {
    ...
    'home.v4.hero.sub': {
      en: 'Half-cuts, engines and truck parts — sourced in China for international buyers. Automotive powertrains only (not electrical power equipment). Request current availability and an EXW quote.',
      zh: '半切车、发动机与卡车配件 — 中国采购，服务国际买家。仅限汽车动力总成（非电力设备）。请获取当前库存与 EXW 报价。',
      fr: 'Demi-coupes, moteurs et pièces camion — sourcés en Chine pour les acheteurs internationaux. Groupes motopropulseurs automobiles uniquement. Demandez la disponibilité actuelle et un devis EXW.',
      ar: 'أنصاف مقطوعة ومحركات وقطع شاحنات — يتم توريدها من الصين للمشترين الدوليين. مجموعات نقل حركة سيارات فقط. اطلب التوفر الحالي وعرض سعر EXW.',
    },
    ...
    'home.v4.stat.halfCuts': { en: 'Half-cuts', zh: '半切车', fr: 'Demi-coupes', ar: 'أنصاف مقطوعة' },
    'home.v4.stat.engines': { en: 'Engine listings', zh: '发动机车源', fr: 'Annonces moteurs', ar: 'قوائم المحركات' },
    ...
    'home.v4.viewDetails': { en: 'Request quote →', zh: '获取报价 →', fr: 'Demander un devis →', ar: 'طلب عرض سعر ←' },
    ...
    'home.video': { en: 'Video', zh: '视频', fr: 'Vidéo', ar: 'فيديو' },
    ...
    'hc.addToQuoteList': { en: 'Add to quote list', zh: '加入询价单', fr: 'Ajouter à la liste de devis', ar: 'أضف إلى قائمة عرض السعر' },
    'hc.photos': { zh: '照片', fr: 'Photos', ar: 'الصور'},
    'hc.video': { en: 'Video', zh: '视频', fr: 'Vidéo', ar: 'مقطع الفيديو'},
    ...
    'hc.vehicleVideo': { en: 'Vehicle video', zh: '车辆视频', fr: 'Vidéo du véhicule', ar: 'فيديو المركبة'},
    ...
    'hc.halfCut': { en: 'Half Cut', zh: '半切车', fr: 'Demi-coupe', ar: 'نصف مقطوعة'},
    ...
    'hc.contactTeam': { en: 'Request quote', zh: '获取报价', fr: 'Demander un devis', ar: 'طلب عرض سعر'},
    ...
    'hc.detailVerifiedSupplier': { en: 'Verified supplier listing', zh: '已验证供应商车源', fr: 'Annonce d’un fournisseur vérifié', ar: 'قائمة مورد تم التحقق منه' },
    'hc.detailExportListing': { en: 'Export listing', zh: '出口车源', fr: 'Annonce export', ar: 'قائمة تصدير' },
