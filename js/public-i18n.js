...
(function () {
  ...
  const STRINGS = {
    ...
    'brands.lead': {
      zh: '选择车辆品牌，查看发动机、变速箱、底盘件及乘用车。AsiaPower 通过中国验证供应网络采购日系、韩系、中美欧多品牌应用。', fr: 'Sélectionnez une marque de véhicule pour accéder aux moteurs, boîtes de vitesses, pièces de châssis et demi-coupes. AsiaPower s\'approvisionne en applications japonaises, coréennes, chinoises, américaines et européennes via un réseau de fournisseurs vérifié basé en Chine.', ar: 'اختر علامة تجارية للسيارة للوصول إلى المحركات وعلب التروس وقطع الشاسيه وأنصاف القطع. تقوم AsiaPower بتزويد التطبيقات اليابانية والكورية والصينية والأمريكية والأوروبية من خلال شبكة مورّدين معتمدة في الصين.'},
    'brands.vehicleBrands': { zh: '车辆品牌', fr: 'MARQUES DE VEHICULES', ar: 'العلامات التجارية للمركبات'},
    ...
    'brands.featuredLead': { zh: '高出货量采购渠道，专属供应商对接、更快报价及出口方案。', fr: 'Canaux d\'approvisionnement à volume élevé avec un accès dédié aux fournisseurs, des programmes de devis et d\'exportation plus rapides.', ar: 'قنوات مصادر كبيرة الحجم مع وصول مخصص للموردين، وبرامج تسعير وتصدير أسرع.'},
    'brands.allEyebrow': { zh: '全面覆盖', fr: 'Infos complètes', ar: 'تغطية شاملة'},
    'brands.allTitle': { zh: '全部支持品牌', fr: 'Toutes les marques prises en charge', ar: 'جميع العلامات التجارية المدعومة'},
    'brands.allLead': { zh: '全球动力总成采购完整品牌索引 — 选择任意品牌索取发动机、变速箱、底盘件或乘用车。', fr: 'Index complet de la marque pour l\'approvisionnement mondial en groupes motopropulseurs — sélectionnez n\'importe quelle marque pour demander des moteurs, des boîtes de vitesses, des pièces de châssis ou des demi-coupes.', ar: 'مؤشر العلامة التجارية الكامل لمصادر مجموعة نقل الحركة العالمية — حدد أي نوع لطلب المحركات أو علب التروس أو أجزاء الشاسيه أو القطع النصفية.'},
