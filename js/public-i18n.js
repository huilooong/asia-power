...
(function () {
  ...
  const STRINGS = {
    ...
    'home.pillar2Desc': { zh: '已向 110+ 国家出口 6,000+ 台套。支持单台 LCL 与整柜批量采购。' },
    'home.pillar3Title': { zh: '供应网络' },
    'home.pillar3Desc': { zh: '200+ 验证供应商覆盖日本、韩国及中国 — 经郑州出口渠道整合。' },
    'home.pillar4Title': { zh: '全球出口' },
    'home.pillar4Desc': { zh: 'FOB/CIF 发运至非洲、美洲、加勒比、中东、东南亚及澳洲。专业出口包装与物流。' },
    ...
    'home.model3Desc': { zh: '非洲、美洲、加勒比、中东、东南亚及澳洲的进口商、维修厂、车队及经销商。' },
    ...
    'home.reachLead': { zh: 'AsiaPower 从中国向六大出口区域发货 — 覆盖非洲各国及美洲、加勒比、中东、东南亚与澳洲。郑州（中国）及阿克拉（加纳）办公室支持全球沟通。' },
    'home.regionAfrica': { zh: '非洲' },
    'home.regionAmericas': { zh: '美洲' },
    'home.regionCaribbean': { zh: '加勒比' },
    'home.regionMiddleEast': { zh: '中东' },
    'home.regionSoutheastAsia': { zh: '东南亚' },
    'home.regionAustralia': { zh: '澳洲' },
    'home.marketIntro': { zh: '我们的出口市场覆盖：' },
    'home.statCountries': { zh: '国家及地区' },
    'home.statPopulation': { zh: '合计人口' },
    'home.statVehicles': { zh: '机动车保有量' },
    'home.statMarket': { zh: '估算年度售后市场规模' },
    'home.marketNote': { zh: '数据为基于公开人口、车辆登记及汽车售后行业资料的近似区域合计。' },
    ...
    'home.faq3A': { zh: '支持。我们提供 FOB/CIF 发运至全球港口，包括非洲、美洲、加勒比、中东、东南亚及澳洲。所有订单规模均支持整柜及 LCL。' },
    ...
    'contact.formLead': { zh: '填写车辆详情。可继续 WhatsApp 获取最快报价；若不使用 WhatsApp，可选择邮件回复。' },
    'contact.preferEmail': { zh: '我希望通过邮件回复 — 我不使用 WhatsApp' },
    'contact.preferEmailHint': { zh: '我们将在 24 小时内回复您的邮箱，不会打开 WhatsApp。' },
    'contact.emailUs': { zh: '邮件联系' },
    'footer.emailUs': { zh: '邮件联系' },
