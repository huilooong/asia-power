...
(function () {
  ...
  const STRINGS = {
"library.articleEnglish":{"en": "Content in English", "zh": "英文内容", "fr": "Contenu en anglais", "ar": "محتوى باللغة الإنجليزية"},
"library.articleFrench":{"en": "Content in French", "zh": "法文内容", "fr": "Contenu en français", "ar": "محتوى باللغة الفرنسية"},

"guidemore.1kd-ftv-engine-east-africa-sourcing":{"en": "1KD-FTV sourcing for East Africa", "zh": "东非 1KD-FTV 发动机采购", "fr": "Approvisionnement en 1KD-FTV pour l’Afrique de l’Est", "ar": "توريد محرك 1KD-FTV لشرق أفريقيا"},
"guidemore.angola-auto-parts-sourcing-guide":{"en": "Auto parts sourcing for Angola", "zh": "安哥拉汽车配件采购", "fr": "Approvisionnement en pièces auto pour l’Angola", "ar": "توريد قطع السيارات لأنغولا"},
"guidemore.botswana-used-engine-import-guide":{"en": "Used engine imports to Botswana", "zh": "博茨瓦纳二手发动机进口", "fr": "Importation de moteurs d’occasion au Botswana", "ar": "استيراد المحركات المستعملة إلى بوتسوانا"},
"guidemore.chinese-auto-parts-kenya-guide":{"en": "Chinese auto parts for Kenya", "zh": "肯尼亚：中国汽车配件采购", "fr": "Pièces automobiles chinoises pour le Kenya", "ar": "قطع السيارات الصينية لكينيا"},
"guidemore.g4fc-engine-ghana-sourcing-guide":{"en": "G4FC engine sourcing for Ghana", "zh": "加纳 G4FC 发动机采购", "fr": "Approvisionnement en moteurs G4FC pour le Ghana", "ar": "توريد محركات G4FC لغانا"},
"guidemore.g4kd-g4ke-hyundai-tucson-africa":{"en": "Tucson G4KD / G4KE sourcing", "zh": "途胜 G4KD／G4KE 发动机采购", "fr": "Approvisionnement Tucson G4KD / G4KE", "ar": "توريد محركات توسان G4KD وG4KE"},
"guidemore.ghana-auto-spare-parts-import-guide":{"en": "Ghana auto parts import guide", "zh": "加纳汽车配件进口指南", "fr": "Guide d’importation de pièces auto au Ghana", "ar": "دليل استيراد قطع السيارات إلى غانا"},
"guidemore.guide-import-moteur-cote-ivoire":{"en": "Used engines: Côte d’Ivoire", "zh": "科特迪瓦二手发动机进口", "fr": "Moteurs d’occasion : Côte d’Ivoire", "ar": "محركات مستعملة: كوت ديفوار"},
"guidemore.half-cut-vehicles-africa-guide":{"en": "Half-cut vehicles for African workshops", "zh": "非洲维修厂半切车采购", "fr": "Demi-carcasses pour les ateliers africains", "ar": "أنصاف السيارات للورش الأفريقية"},
"guidemore.importation-pieces-auto-senegal":{"en": "Auto parts from China to Senegal", "zh": "从中国向塞内加尔进口汽车配件", "fr": "Pièces auto de Chine vers le Sénégal", "ar": "قطع السيارات من الصين إلى السنغال"},
"guidemore.importer-moteur-occasion-cameroun":{"en": "Used engine imports to Cameroon", "zh": "喀麦隆二手发动机进口", "fr": "Importation de moteurs d’occasion au Cameroun", "ar": "استيراد المحركات المستعملة إلى الكاميرون"},
"guidemore.nigeria-customs-used-auto-parts":{"en": "Nigeria: used auto parts customs guide", "zh": "尼日利亚二手汽车配件清关", "fr": "Nigeria : dédouanement des pièces d’occasion", "ar": "نيجيريا: تخليص قطع السيارات المستعملة"},
"guidemore.pieces-auto-chine-afrique-francophone":{"en": "Auto parts for French-speaking Africa", "zh": "法语非洲地区汽车配件采购", "fr": "Pièces auto pour l’Afrique francophone", "ar": "قطع السيارات لأفريقيا الناطقة بالفرنسية"},
"guidemore.used-gearbox-sourcing-africa":{"en": "Used gearbox sourcing from China", "zh": "从中国采购二手变速箱", "fr": "Acheter une boîte de vitesses d’occasion en Chine", "ar": "توريد نواقل الحركة المستعملة من الصين"},
"guidemore.used-toyota-engine-nigeria-guide":{"en": "Toyota engine sourcing for Nigeria", "zh": "尼日利亚丰田发动机采购", "fr": "Moteurs Toyota pour le Nigeria", "ar": "محركات تويوتا لنيجيريا"},
"guidemore.heading":{"en": "Market and product articles", "zh": "市场与产品采购文章", "fr": "Articles par marché et produit", "ar": "مقالات حسب السوق والمنتج"},

"hc.loadingDetail":{"en": "Loading listing…", "zh": "正在加载商品…", "fr": "Chargement de l’annonce…", "ar": "جارٍ تحميل الإعلان…"},
"hc.prevPhoto":{"en": "Previous photo", "zh": "上一张图片", "fr": "Photo précédente", "ar": "الصورة السابقة"},
"hc.nextPhoto":{"en": "Next photo", "zh": "下一张图片", "fr": "Photo suivante", "ar": "الصورة التالية"},
"hc.photoGallery":{"en": "Photo gallery", "zh": "实物图片", "fr": "Galerie de photos", "ar": "معرض الصور"},
"hc.fullScreen":{"en": "Full screen", "zh": "全屏查看", "fr": "Plein écran", "ar": "ملء الشاشة"},
"hc.vehicleInfo":{"en": "Vehicle information", "zh": "车辆信息", "fr": "Informations sur le véhicule", "ar": "معلومات السيارة"},
"hc.detailExportLead":{"en": "EXW export from China — availability, photos and CIF shipping confirmed on enquiry.", "zh": "从中国按 EXW 条款供货；库存、实物照片及 CIF 运输方案在询价时确认。", "fr": "Export depuis la Chine aux conditions EXW ; disponibilité, photos et transport CIF à confirmer sur demande.", "ar": "توريد من الصين بشروط EXW؛ يُؤكَّد التوفر والصور وخيار الشحن CIF عند الاستفسار."},
"nav.engines":{"en": "Engines", "zh": "发动机", "fr": "Moteurs", "ar": "المحركات"},
"hc.detailVerifiedSupplier":{"en": "Verified supplier listing", "zh": "已核验供应商商品", "fr": "Annonce d’un fournisseur vérifié", "ar": "إعلان من مورد تم التحقق منه"},
"hc.detailExportListing":{"en": "Export listing", "zh": "出口商品", "fr": "Annonce pour l’export", "ar": "إعلان للتصدير"},

"guidehub.title":{"en": "Blog & Buying Guides", "zh": "博客与采购指南", "fr": "Blog et guides d’achat", "ar": "المدونة وأدلة الشراء"},
"guidehub.intro":{"en": "Find the right engine code, understand what is included and prepare your shipment from China.", "zh": "查找发动机编码，了解供货范围，准备从中国采购与运输。", "fr": "Identifiez le code moteur, vérifiez les éléments inclus et préparez votre expédition depuis la Chine.", "ar": "حدّد رمز المحرك وتحقّق من المكونات المشمولة وجهّز شحنتك من الصين."},
"guidehub.engine":{"en": "Engine code articles", "zh": "发动机编码文章目录", "fr": "Articles par code moteur", "ar": "مقالات رموز المحركات"},
"guidehub.engineDesc":{"en": "Search by brand and full code. Check models, years and market differences.", "zh": "按品牌及完整编码检索，核对车型、年份和市场差异。", "fr": "Recherchez par marque et code complet. Vérifiez modèles, années et marchés.", "ar": "ابحث حسب العلامة والرمز الكامل، وراجع الطراز والسنوات والسوق."},
"guidehub.buying":{"en": "Buying used engines from China", "zh": "从中国采购二手发动机", "fr": "Acheter un moteur d’occasion en Chine", "ar": "شراء محركات مستعملة من الصين"},
"guidehub.buyingDesc":{"en": "Compare the engine identity, included parts and inspection evidence before price.", "zh": "比价前，先核对发动机身份、所含部件及检测资料。", "fr": "Avant le prix, comparez l’identité du moteur, les pièces incluses et les preuves d’inspection.", "ar": "قبل مقارنة السعر، تحقّق من هوية المحرك والقطع المشمولة وأدلة الفحص."},
"guidehub.shipping":{"en": "FOB and CIF shipping guide", "zh": "FOB 与 CIF 运输指南", "fr": "Guide de transport FOB et CIF", "ar": "دليل الشحن FOB وCIF"},
"guidehub.shippingDesc":{"en": "Understand quotation scope, shipping responsibilities and destination costs.", "zh": "了解报价范围、运输责任及目的地费用。", "fr": "Comprenez le périmètre du devis, les responsabilités et les frais à destination.", "ar": "افهم نطاق عرض السعر ومسؤوليات الشحن وتكاليف الوجهة."},
"guidehub.requirements":{"en": "Prepare your enquiry", "zh": "准备采购需求", "fr": "Préparez votre demande", "ar": "جهّز طلبك"},
"guidehub.step0":{"en": "Provide the vehicle model, year, full engine code and gearbox type.", "zh": "提供车型、年份、完整发动机编码及变速箱型号。", "fr": "Indiquez le modèle, l’année, le code moteur complet et le type de boîte.", "ar": "أرسل الطراز والسنة ورمز المحرك الكامل ونوع ناقل الحركة."},
"guidehub.step1":{"en": "Specify a bare engine, long block, engine with accessories or a complete half-cut.", "zh": "明确需要裸机、长机、带附件总成，还是完整半切车。", "fr": "Précisez : moteur nu, bloc long, moteur avec accessoires ou demi-carcasse complète.", "ar": "حدّد المطلوب: محرك مجرد، أو كتلة طويلة، أو محرك بملحقاته، أو نصف سيارة كامل."},
"guidehub.step2":{"en": "Include the destination country and port, then agree the quotation and delivery scope.", "zh": "提供目的国及港口，再确认报价与交付范围。", "fr": "Indiquez le pays et le port, puis convenez du devis et du périmètre de livraison.", "ar": "أضف بلد وميناء الوصول، ثم اتفق على نطاق السعر والتسليم."},
"guidehub.faq":{"en": "Before placing an order", "zh": "下单前需要确认", "fr": "Avant de commander", "ar": "قبل الطلب"},
"guidehub.q0":{"en": "Is the same engine family enough to confirm compatibility?", "zh": "同系列发动机就一定通用吗？", "fr": "La même famille moteur garantit-elle la compatibilité ?", "ar": "هل تضمن عائلة المحرك نفسها التوافق؟"},
"guidehub.a0":{"en": "No. Compare the complete code, donor vehicle, wiring, ECU, emissions version and transmission with your workshop.", "zh": "不能。请与维修厂共同核对完整编码、供体车型、线束、控制单元、排放版本及变速箱。", "fr": "Non. Vérifiez avec votre atelier le code complet, le véhicule donneur, le câblage, le calculateur, la version antipollution et la boîte.", "ar": "لا. راجع مع ورشتك الرمز الكامل والسيارة المانحة والأسلاك ووحدة التحكم ونسخة الانبعاثات وناقل الحركة."},
"guidehub.q1":{"en": "What evidence should I request for the offered engine?", "zh": "应该索取哪些实物资料？", "fr": "Quelles preuves demander pour le moteur proposé ?", "ar": "ما الأدلة المطلوبة للمحرك المعروض؟"},
"guidehub.a1":{"en": "Request readable engine-code photos, the stock reference, an agreed component list and inspection or startup evidence for that specific unit.", "zh": "索取清晰的发动机编码照片、库存编号、约定的部件清单，以及对应实物的检测或启动资料。", "fr": "Demandez une photo lisible du code, la référence de stock, la liste convenue des pièces et les preuves d’inspection ou de démarrage de cette unité.", "ar": "اطلب صورًا واضحة لرمز المحرك ورقم المخزون وقائمة المكونات المتفق عليها وأدلة فحص أو تشغيل الوحدة نفسها."},


    "library.buying": {"en": "Buying & shipping guides", "zh": "采购与运输指南", "fr": "Guides d’achat et de transport", "ar": "أدلة الشراء والشحن"},
    "library.engines": {"en": "Engine code articles", "zh": "发动机编码文章目录", "fr": "Articles par code moteur", "ar": "مقالات رموز المحركات"},
    "library.kicker": {"en": "Buyer library", "zh": "采购知识库", "fr": "Bibliothèque des acheteurs", "ar": "مكتبة المشتري"},
    "library.intro": {"en": "Start with the engine code, or learn how to prepare a purchase and shipment.", "zh": "按发动机编码查找车型资料，或了解采购与运输流程。", "fr": "Recherchez un code moteur ou préparez votre achat et votre expédition.", "ar": "ابحث برمز المحرك أو تعرّف على خطوات الشراء والشحن."},
    "library.engineDesc": {"en": "Browse by brand and complete code. Check China-market models, years and version differences.", "zh": "按品牌和完整编码查找中国市场车型、适用年份及版本差异。", "fr": "Consultez les marques et codes complets, les modèles du marché chinois, les années et les variantes.", "ar": "تصفّح حسب العلامة والرمز الكامل، وراجع طرازات السوق الصينية والسنوات واختلافات النسخ."},
    "library.buyingDesc": {"en": "Understand engine packages, inspection evidence, quotation scope and shipping terms.", "zh": "了解发动机供货范围、检测资料、报价内容及运输条款。", "fr": "Comprenez les ensembles moteur, les preuves d’inspection, le contenu du devis et les conditions de transport.", "ar": "تعرّف على مكونات التوريد وأدلة الفحص ونطاق عرض السعر وشروط الشحن."},
    "library.browseCodes": {"en": "Browse engine codes →", "zh": "查看发动机编码目录 →", "fr": "Voir les codes moteur →", "ar": "تصفّح رموز المحركات ←"},
    "library.browseGuides": {"en": "Read buying guides →", "zh": "阅读采购指南 →", "fr": "Lire les guides d’achat →", "ar": "اقرأ أدلة الشراء ←"},
    ...
    'parts.submoduleTires': { en: 'Used tires', zh: '废旧轮胎', fr: 'Pneus usagés', ar: 'إطارات مستعملة' },
    ...
    'catalog.tires': { en: 'Used tires', zh: '废旧轮胎', fr: 'Pneus usagés', ar: 'إطارات مستعملة' },
    'tires.title': { en: 'Used / Scrap Tires', zh: '废旧轮胎目录', fr: 'Catalogue de pneus usagés', ar: 'كتالوج الإطارات المستعملة' },
    ...
    /* Circular inventory ledger homepage */
    'home.circular.nav.inventory': { en: 'All inventory', zh: '全部循环库存', fr: 'Tout le stock', ar: 'كل المخزون' },
    'home.circular.nav.vehicles': { en: 'Complete vehicles', zh: '整车', fr: 'Véhicules complets', ar: 'مركبات كاملة' },
    'home.circular.nav.powertrain': { en: 'Powertrains', zh: '动力总成', fr: 'Groupes motopropulseurs', ar: 'مجموعات نقل الحركة' },
    'home.circular.nav.commercial': { en: 'Commercial vehicles', zh: '商用车辆', fr: 'Véhicules utilitaires', ar: 'مركبات تجارية' },
    'home.circular.nav.machinery': { en: 'Construction machinery', zh: '工程机械', fr: 'Engins de chantier', ar: 'معدات إنشائية' },
    'home.circular.nav.parts': { en: 'Body & chassis', zh: '车身与底盘', fr: 'Carrosserie et châssis', ar: 'الهيكل والشاسيه' },
    'home.circular.supplierShort': { en: 'Supplier entry', zh: '供应商入口', fr: 'Accès fournisseur', ar: 'دخول الموردين' },
    'home.circular.searchKicker': { en: 'Global sourcing search', zh: '全球采购检索', fr: 'Recherche d’approvisionnement', ar: 'بحث التوريد العالمي' },
    'home.circular.searchLabel': { en: 'I am looking for', zh: '我正在寻找', fr: 'Je recherche', ar: 'أبحث عن' },
    'home.circular.searchPlaceholder': { en: 'Search make, model, engine code, stock ID or OEM number', zh: '搜索品牌、车型、发动机代码、库存号或 OEM 编号', fr: 'Marque, modèle, code moteur, n° stock ou référence OEM', ar: 'ابحث بالعلامة أو الطراز أو رمز المحرك أو رقم المخزون أو OEM' },
    'home.circular.searchButton': { en: 'Search inventory', zh: '搜索库存', fr: 'Rechercher', ar: 'بحث المخزون' },
    'home.circular.supplierEntry': { en: 'Suppliers: publish and manage inventory', zh: '供应商：发布并管理库存', fr: 'Fournisseurs : publier et gérer le stock', ar: 'الموردون: نشر المخزون وإدارته' },
    'home.circular.guides': {"en": "Blog & Buying Guides", "zh": "博客与采购指南", "fr": "Blog et guides d’achat", "ar": "المدونة وأدلة الشراء"},
    'home.circular.heroEyebrow': { en: 'Global circular automotive supply chain', zh: '全球汽车循环供应链', fr: 'Chaîne automobile circulaire mondiale', ar: 'سلسلة توريد عالمية دائرية للسيارات' },
    'home.circular.heroTitle': {
      en: 'Not about making more.<br>About keeping automotive assets<br><em>in useful circulation.</em>',
      zh: '不是制造更多，<br>而是让现有汽车资产<br><em>持续发挥价值。</em>',
      fr: 'Pas produire davantage.<br>Mais maintenir les actifs automobiles<br><em>en circulation utile.</em>',
      ar: 'لا ننتج المزيد.<br>بل نبقي أصول السيارات<br><em>في دورة استخدام مفيدة.</em>',
    },
    'home.circular.heroLead': {
      en: 'AsiaPower connects vehicles, powertrains, commercial assets, machinery and parts that still have useful life with their next real use—through live inventory and original evidence.',
      zh: 'AsiaPower 连接仍有使用价值的整车、动力总成、商用车辆、机械与部件，以实时库存和原始证据匹配下一次真实使用。',
      fr: 'AsiaPower relie les véhicules, groupes motopropulseurs, actifs utilitaires, engins et pièces encore utiles à leur prochain usage réel, sur la base du stock en direct et des preuves d’origine.',
      ar: 'تربط AsiaPower المركبات ومجموعات نقل الحركة والأصول التجارية والمعدات والقطع التي ما زالت صالحة بالاستخدام الحقيقي التالي، اعتماداً على المخزون المباشر والأدلة الأصلية.',
    },
    'home.circular.browseInventory': { en: 'Browse circular inventory', zh: '浏览循环库存', fr: 'Parcourir le stock circulaire', ar: 'تصفح المخزون الدائري' },
    'home.circular.factScope': { en: 'Asset scope', zh: '资产范围', fr: 'Périmètre des actifs', ar: 'نطاق الأصول' },
    'home.circular.factScopeValue': { en: 'Vehicles · powertrains · machinery · parts', zh: '整车 · 动力总成 · 机械 · 部件', fr: 'Véhicules · groupes motopropulseurs · engins · pièces', ar: 'مركبات · مجموعات نقل حركة · معدات · قطع' },
    'home.circular.factBasis': { en: 'Transaction basis', zh: '交易依据', fr: 'Base de transaction', ar: 'أساس المعاملة' },
    'home.circular.factBasisValue': { en: 'Stock ID · specifications · original media', zh: '库存号 · 规格参数 · 原始媒体', fr: 'N° stock · caractéristiques · médias d’origine', ar: 'رقم المخزون · المواصفات · الوسائط الأصلية' },
    'home.circular.ledgerKicker': { en: 'Circular inventory ledger', zh: '循环库存账本', fr: 'Registre du stock circulaire', ar: 'سجل المخزون الدائري' },
    'home.circular.ledgerTitle': { en: 'Live circular inventory', zh: '实时循环库存', fr: 'Stock circulaire en direct', ar: 'مخزون دائري مباشر' },
    'home.circular.columnAsset': { en: 'Asset', zh: '资产', fr: 'Actif', ar: 'الأصل' },
    'home.circular.columnEvidence': { en: 'Evidence', zh: '证据', fr: 'Preuves', ar: 'الأدلة' },
    'home.circular.ledgerFootnote': { en: 'Original customer media is retained and normalized inside a consistent viewing window.', zh: '保留客户原始媒体，并在统一的浏览窗口中规范呈现。', fr: 'Les médias d’origine sont conservés et présentés dans une fenêtre visuelle cohérente.', ar: 'تُحفظ وسائط العميل الأصلية وتُعرض ضمن نافذة مشاهدة موحدة.' },
    'home.circular.viewAll': { en: 'View all inventory', zh: '查看全部库存', fr: 'Voir tout le stock', ar: 'عرض كل المخزون' },
    'home.circular.evidenceCount': { en: '{n} original evidence items', zh: '{n} 项原始证据', fr: '{n} preuves d’origine', ar: '{n} عناصر أدلة أصلية' },
    'home.circular.routeVehicle': { en: 'Complete vehicle reuse', zh: '整车再次使用', fr: 'Réemploi du véhicule complet', ar: 'إعادة استخدام المركبة كاملة' },
    'home.circular.routePowertrain': { en: 'Powertrain reuse', zh: '动力总成再利用', fr: 'Réemploi du groupe motopropulseur', ar: 'إعادة استخدام مجموعة نقل الحركة' },
    'home.circular.routeCommercial': { en: 'Commercial asset reuse', zh: '商用资产延长使用', fr: 'Réemploi d’un actif utilitaire', ar: 'إعادة استخدام الأصل التجاري' },
    'home.circular.routeMachinery': { en: 'Machinery reuse', zh: '工程机械继续使用', fr: 'Réemploi d’un engin', ar: 'إعادة استخدام المعدات' },
    'home.circular.routeParts': { en: 'Core parts reuse', zh: '核心部件再利用', fr: 'Réemploi des pièces essentielles', ar: 'إعادة استخدام القطع الأساسية' },
    'home.circular.cycleKicker': { en: 'How the platform creates circulation', zh: '平台如何形成循环', fr: 'Comment la plateforme crée la circulation', ar: 'كيف تنشئ المنصة دورة الاستخدام' },
    'home.circular.cycleTitle': { en: 'From a real asset to its next useful life.', zh: '从真实资产，到下一次有效使用。', fr: 'D’un actif réel à sa prochaine vie utile.', ar: 'من أصل حقيقي إلى عمره المفيد التالي.' },
    'home.circular.stepAsset': { en: 'Real asset', zh: '真实资产', fr: 'Actif réel', ar: 'أصل حقيقي' },
    'home.circular.stepEvidence': { en: 'Standardized evidence', zh: '标准化证据', fr: 'Preuves normalisées', ar: 'أدلة موحدة' },
    'home.circular.stepMatch': { en: 'Global matching', zh: '全球匹配', fr: 'Mise en relation mondiale', ar: 'مطابقة عالمية' },
    'home.circular.stepUse': { en: 'Next use', zh: '再次使用', fr: 'Nouvel usage', ar: 'الاستخدام التالي' },
    'home.circular.routesKicker': { en: 'Browse by next-use route', zh: '按资产去向浏览', fr: 'Parcourir par prochain usage', ar: 'تصفح حسب الاستخدام التالي' },
    'home.circular.routesTitle': { en: 'Inventory organized by<br>what it can do next.', zh: '不是按“新旧”分类，<br>而是按下一次用途组织库存。', fr: 'Un stock organisé selon<br>son prochain usage.', ar: 'مخزون منظم حسب<br>ما يمكنه فعله لاحقاً.' },
    'home.circular.routesLead': { en: 'One inventory, evidence and quotation standard across vehicles, engines, gearboxes, trucks, machinery and body parts.', zh: '同一套库存、证据和询价标准，覆盖整车、发动机、变速箱、卡车、机械与车身底盘。', fr: 'Une seule norme de stock, de preuve et de devis pour véhicules, moteurs, boîtes, camions, engins et pièces de carrosserie.', ar: 'معيار واحد للمخزون والأدلة وعروض الأسعار للمركبات والمحركات وعلب التروس والشاحنات والمعدات وقطع الهيكل.' },
    'home.circular.routeVehicleTitle': { en: 'Complete vehicle reuse', zh: '整车再次使用', fr: 'Réemploi du véhicule complet', ar: 'إعادة استخدام المركبة كاملة' },
    'home.circular.routeVehicleText': { en: 'Match complete vehicles with their next cross-border user.', zh: '让完整车辆匹配下一位跨境使用者。', fr: 'Relier un véhicule complet à son prochain utilisateur transfrontalier.', ar: 'مطابقة المركبات الكاملة مع مستخدمها التالي عبر الحدود.' },
    'home.circular.routePowertrainTitle': { en: 'Powertrain reuse', zh: '动力总成再利用', fr: 'Réemploi des groupes motopropulseurs', ar: 'إعادة استخدام مجموعات نقل الحركة' },
    'home.circular.routePowertrainText': { en: 'Engines and gearboxes for repair, replacement and rebuild.', zh: '发动机与变速箱用于维修、替换和重建。', fr: 'Moteurs et boîtes pour réparation, remplacement et remise en état.', ar: 'محركات وعلب تروس للإصلاح والاستبدال وإعادة البناء.' },
    'home.circular.routeCommercialTitle': { en: 'Commercial asset reuse', zh: '商用资产延长使用', fr: 'Réemploi des actifs utilitaires', ar: 'إعادة استخدام الأصول التجارية' },
    'home.circular.routeCommercialText': { en: 'Keep trucks and cabs serving transport and production.', zh: '让卡车与驾驶室继续服务运输和生产需求。', fr: 'Maintenir camions et cabines au service du transport et de la production.', ar: 'إبقاء الشاحنات والمقصورات في خدمة النقل والإنتاج.' },
    'home.circular.routeMachineryTitle': { en: 'Machinery reuse', zh: '工程机械继续使用', fr: 'Réemploi des engins', ar: 'إعادة استخدام المعدات' },
    'home.circular.routeMachineryText': { en: 'Move equipment into its next project or production setting.', zh: '让设备进入新的工程或生产场景。', fr: 'Affecter les engins à leur prochain chantier ou environnement de production.', ar: 'نقل المعدات إلى مشروعها أو بيئة إنتاجها التالية.' },
    'home.circular.routePartsTitle': { en: 'Core parts reuse', zh: '核心部件再利用', fr: 'Réemploi des pièces essentielles', ar: 'إعادة استخدام القطع الأساسية' },
    'home.circular.routePartsText': { en: 'Recover usable assemblies and body parts from existing assets.', zh: '从现有资产中释放仍可使用的总成与车身部件。', fr: 'Récupérer les ensembles et pièces de carrosserie encore utilisables.', ar: 'استعادة التجميعات وقطع الهيكل القابلة للاستخدام من الأصول الحالية.' },
    'home.circular.evidenceKicker': { en: 'Circular value needs evidence', zh: '循环价值必须有证据', fr: 'La valeur circulaire exige des preuves', ar: 'القيمة الدائرية تحتاج إلى أدلة' },
    'home.circular.evidenceTitle': { en: 'No invented environmental claims.<br>Only asset facts that can be checked.', zh: '不制造环保数字。<br>只呈现可以核查的资产事实。', fr: 'Pas d’allégations environnementales inventées.<br>Seulement des faits vérifiables.', ar: 'لا ادعاءات بيئية مختلقة.<br>فقط حقائق أصول قابلة للتحقق.' },
    'home.circular.evidenceLead': { en: 'Media dimensions can vary. Stock IDs, specifications, original media and verification boundaries cannot.', zh: '图片规格可以不同，但库存号、参数、原始媒体与验证边界必须一致。', fr: 'Les formats des médias peuvent varier. Les n° stock, caractéristiques, médias d’origine et limites de vérification restent cohérents.', ar: 'قد تختلف أبعاد الوسائط، لكن أرقام المخزون والمواصفات والوسائط الأصلية وحدود التحقق يجب أن تبقى متسقة.' },
    'home.circular.proofInventory': { en: 'Real inventory', zh: '真实库存', fr: 'Stock réel', ar: 'مخزون حقيقي' },
    'home.circular.proofInventoryText': { en: 'Every asset has a stock ID and current availability state.', zh: '每项资产对应明确库存号和当前状态。', fr: 'Chaque actif possède un n° stock et un état de disponibilité actuel.', ar: 'لكل أصل رقم مخزون وحالة توفر حالية.' },
    'home.circular.proofMedia': { en: 'Original media', zh: '原始媒体', fr: 'Médias d’origine', ar: 'الوسائط الأصلية' },
    'home.circular.proofMediaText': { en: 'Video appears first when present while original evidence photos remain available.', zh: '有视频时优先展示视频，同时保留原始证据图。', fr: 'La vidéo est prioritaire lorsqu’elle existe, sans supprimer les photos d’origine.', ar: 'يُعرض الفيديو أولاً عند توفره مع إبقاء صور الأدلة الأصلية.' },
    'home.circular.proofSpecs': { en: 'Standardized specifications', zh: '标准参数', fr: 'Caractéristiques normalisées', ar: 'مواصفات موحدة' },
    'home.circular.proofSpecsText': { en: 'Make, model, year, mileage and price follow one information order.', zh: '品牌、车型、年份、里程和价格使用统一信息顺序。', fr: 'Marque, modèle, année, kilométrage et prix suivent un ordre unique.', ar: 'تتبع العلامة والطراز والسنة والمسافة والسعر ترتيب معلومات واحداً.' },
    'home.circular.proofVerified': { en: 'Clear verification boundary', zh: '明确验证边界', fr: 'Périmètre de vérification clair', ar: 'حدود تحقق واضحة' },
    'home.circular.proofVerifiedText': { en: 'Verified status appears only for inventory whose supplier completed the relevant checks.', zh: '仅对供应商已完成相应核验的库存显示“已验证”。', fr: 'Le statut vérifié n’apparaît que lorsque le fournisseur a passé les contrôles correspondants.', ar: 'تظهر حالة موثق فقط للمخزون الذي أكمل مورده عمليات التحقق المطلوبة.' },
    'home.circular.liveStockTitle': { en: 'Explore current assets', zh: '浏览当前可用资产', fr: 'Explorer les actifs disponibles', ar: 'استكشف الأصول المتاحة' },
    'home.circular.footerText': { en: 'Connecting real automotive assets with real demand for their next useful life.', zh: '让真实汽车资产重新连接真实需求。', fr: 'Relier des actifs automobiles réels à une demande réelle pour leur prochaine vie utile.', ar: 'ربط أصول سيارات حقيقية بطلب حقيقي لعمرها المفيد التالي.' },
    'home.circular.footerInventory': { en: 'Inventory', zh: '库存', fr: 'Stock', ar: 'المخزون' },
    'home.circular.supplierManage': { en: 'Supplier publish & manage', zh: '供应商发布与管理', fr: 'Publication et gestion fournisseur', ar: 'نشر المورد وإدارته' },
    'home.circular.footerNeed': { en: 'Have a sourcing requirement?', zh: '有明确采购需求？', fr: 'Vous avez un besoin d’approvisionnement ?', ar: 'لديك متطلب توريد؟' },
    'home.circular.footerNeedText': { en: 'Send the make, model, year, engine code and destination. The quotation team will confirm the right inventory.', zh: '发送品牌、车型、年份、发动机代码和目的地，报价团队会先确认匹配库存。', fr: 'Envoyez marque, modèle, année, code moteur et destination. L’équipe devis confirmera le stock adapté.', ar: 'أرسل العلامة والطراز والسنة ورمز المحرك والوجهة، وسيؤكد فريق التسعير المخزون المناسب.' },
    'home.circular.privacy': { en: 'Privacy policy', zh: '隐私政策', fr: 'Politique de confidentialité', ar: 'سياسة الخصوصية' },
    ...
    'contact.title': { zh: '联系我们', fr: 'Nous contacter', ar: 'تواصل معنا'},
    ...
    'supplier.uploadExportUsedCars': { en: 'Export Used Cars', zh: '出口二手车', fr: 'Véhicules d’occasion à l’export', ar: 'سيارات مستعملة للتصدير' },
    'supplier.uploadExportUsedCarsDesc': { en: 'Whole vehicles for export — running or repairable, not dismantled or half-cut', zh: '出口整车 — 可启动或可修复，不是拆解车或半切车', fr: 'Véhicules complets à exporter — roulants ou réparables, non démontés', ar: 'مركبات كاملة للتصدير — صالحة للسير أو قابلة للإصلاح' },
    'supplier.uploadExportUsedCarsRule': { en: 'VIN required · whole vehicle only', zh: '须填 VIN · 仅限整车', fr: 'VIN obligatoire · véhicule complet uniquement', ar: 'VIN مطلوب · مركبة كاملة فقط' },
    'supplier.uploadStartExportUsedCar': { en: 'Start export used car upload →', zh: '开始上传出口二手车 →', fr: 'Commencer l’envoi export →', ar: 'بدء رفع السيارة المستعملة للتصدير →' },
    'supplier.uploadPassengerParts': { en: 'Passenger Parts', zh: '乘用车配件', fr: 'Pièces véhicules particuliers', ar: 'قطع سيارات الركاب' },
    'supplier.uploadPassengerPartsDesc': { en: 'Front cut, engine, transmission, chassis, tires & other', zh: '前头、发动机、变速箱、底盘、废旧轮胎及其他', fr: 'Avant, moteur, boîte, châssis, pneus et autres', ar: 'مقدمة ومحرك وعلبة تروس وهيكل وإطارات وقطع أخرى' },
    ...
    'supplier.uploadPage.exportUsedCarTitle': { en: 'Export Used Car Upload', zh: '出口二手车上传', fr: 'Téléversement véhicule d’occasion export', ar: 'رفع سيارة مستعملة للتصدير' },
    'supplier.uploadPage.exportUsedCarLead': { en: 'Upload a complete running or repairable vehicle for export. This channel is for whole vehicles only — no dismantled vehicles or half-cuts. Enter the VIN first and upload at least 3 clear photos.', zh: '上传可启动或可修复的出口整车。本入口仅限整车，不接收拆解车或半切车。请先输入 VIN，并上传至少 3 张清晰照片。', fr: 'Téléversez un véhicule complet roulant ou réparable pour l’export. Véhicules complets uniquement — pas de véhicule démonté ni demi-coupé. Saisissez le VIN et ajoutez au moins 3 photos.', ar: 'ارفع مركبة كاملة صالحة للسير أو قابلة للإصلاح للتصدير. هذا المسار للمركبات الكاملة فقط — بدون مركبات مفككة أو نصف مقطوعة. أدخل VIN وارفع 3 صور واضحة على الأقل.' },
    'supplier.uploadPage.exportUsedCarCrumb': { en: 'Export Used Car Upload', zh: '出口二手车上传', fr: 'Téléversement véhicule d’occasion export', ar: 'رفع سيارة مستعملة للتصدير' },
    ...
    'hc.usedCarCompleteListing': { en: 'Complete vehicle export listing', zh: '出口整车库存', fr: 'Annonce de véhicule complet à l’export', ar: 'إعلان مركبة كاملة للتصدير' },
    'hc.usedCarDetailLead': { en: 'Complete, undismantled China export used vehicle with VIN. Availability, documents and destination eligibility are confirmed before contract.', zh: '中国出口二手整车，具备 VIN 底盘号并保持完整未拆解。签订合同前确认库存、出口文件和目的国准入条件。', fr: 'Véhicule d’occasion complet et non démonté destiné à l’export depuis la Chine avec VIN. Disponibilité, documents et admissibilité sont confirmés avant contrat.', ar: 'مركبة مستعملة كاملة وغير مفككة للتصدير من الصين مع رقم هيكل. يتم تأكيد التوفر والوثائق وأهلية بلد الوجهة قبل العقد.' },
    'hc.usedCarIdentityTitle': { en: 'Export vehicle identity', zh: '出口车辆身份', fr: 'Identité du véhicule export', ar: 'هوية مركبة التصدير' },
    'hc.usedCarIdentityHeading': { en: 'Complete vehicle & export status', zh: '整车身份与出口状态', fr: 'Véhicule complet et statut export', ar: 'المركبة الكاملة وحالة التصدير' },
    'hc.usedCarIdentityLabel': { en: 'Vehicle identity', zh: '车辆身份', fr: 'Identité du véhicule', ar: 'هوية المركبة' },
    'hc.usedCarIdentityValue': { en: 'Complete late-model used vehicle · VIN-listed · not dismantled', zh: '准新二手整车 · 已登记 VIN · 非拆解车辆', fr: 'Véhicule d’occasion récent complet · VIN indiqué · non démonté', ar: 'مركبة مستعملة حديثة كاملة · رقم الهيكل مدرج · غير مفككة' },
    'hc.usedCarSupplierLabel': { en: 'Supplier declaration', zh: '供应商声明', fr: 'Déclaration fournisseur', ar: 'إقرار المورد' },
    'hc.usedCarSupplierDeclared': { en: 'Whole-vehicle export availability declared by supplier', zh: '供应商声明可按整车出口', fr: 'Disponibilité pour export complet déclarée par le fournisseur', ar: 'أعلن المورد توفرها للتصدير كمركبة كاملة' },
    'hc.usedCarSupplierNotRecorded': { en: 'Whole-vehicle export declaration not recorded', zh: '尚未记录供应商整车出口声明', fr: 'Déclaration d’export complet non enregistrée', ar: 'لم يتم تسجيل إقرار التصدير كمركبة كاملة' },
    'hc.usedCarDocsLabel': { en: 'AsiaPower document review', zh: 'AsiaPower 文件核验', fr: 'Contrôle documentaire AsiaPower', ar: 'مراجعة وثائق AsiaPower' },
    'hc.usedCarDocsVerified': { en: 'Export document review verified by AsiaPower', zh: '出口文件已经 AsiaPower 核验', fr: 'Documents d’export vérifiés par AsiaPower', ar: 'تم التحقق من وثائق التصدير بواسطة AsiaPower' },
    'hc.usedCarDocsPending': { en: 'AsiaPower document review pending — confirmed before contract and shipment', zh: 'AsiaPower 文件核验待完成 — 签约及发运前必须确认', fr: 'Contrôle documentaire AsiaPower en attente — confirmation avant contrat et expédition', ar: 'مراجعة وثائق AsiaPower قيد الانتظار — تُؤكد قبل العقد والشحن' },
    'hc.usedCarExportConditionLabel': { en: 'China export condition', zh: '中国出口条件', fr: 'Conditions d’export Chine', ar: 'شروط التصدير من الصين' },
    'hc.usedCarExportConditionValue': { en: 'Registration, inspection, export licence and destination compliance required before shipment', zh: '发运前须完成车辆登记、检验、出口许可证及目的国合规核验', fr: 'Immatriculation, inspection, licence d’export et conformité du pays de destination requises avant expédition', ar: 'يلزم التسجيل والفحص وترخيص التصدير والامتثال لبلد الوجهة قبل الشحن' },
    'hc.usedCarExportDisclaimer': { en: 'This listing is a complete, undismantled used vehicle for whole-vehicle export. Export shipment proceeds only after registration, inspection, export licensing and destination-market requirements are verified for the order.', zh: '本库存为完整未拆解的出口二手整车。仅在订单对应的车辆登记、检验、出口许可证和目的国准入要求核验完成后安排出口发运。', fr: 'Cette annonce concerne un véhicule d’occasion complet et non démonté destiné à l’export. L’expédition n’a lieu qu’après vérification de l’immatriculation, de l’inspection, de la licence d’export et des exigences du marché de destination.', ar: 'هذا الإعلان لمركبة مستعملة كاملة وغير مفككة للتصدير. يتم الشحن فقط بعد التحقق من التسجيل والفحص وترخيص التصدير ومتطلبات سوق الوجهة.' },
    'hc.allExportUsedCars': { en: 'All Export Used Cars', zh: '全部出口二手车', fr: 'Tous les véhicules d’occasion export', ar: 'كل السيارات المستعملة للتصدير' },
    'ebay.usedCarsHeroTitle': { en: 'Export Used Cars from China', zh: '中国出口二手车', fr: 'Véhicules d’occasion exportés de Chine', ar: 'سيارات مستعملة للتصدير من الصين' },
    'ebay.usedCarsHeroLead': { en: 'Complete late-model vehicles · VIN-listed · document review before shipment', zh: '准新二手整车 · 已登记 VIN · 发运前核验出口文件', fr: 'Véhicules récents complets · VIN indiqué · contrôle documentaire avant expédition', ar: 'مركبات حديثة كاملة · رقم الهيكل مدرج · مراجعة الوثائق قبل الشحن' },
    'ebay.usedCarsMetaDescription': { en: 'Complete export used cars from China with VIN, mileage and document-review status. Browse late-model BYD and other vehicles for compliant international shipment.', zh: '浏览中国出口二手整车，清楚查看 VIN、里程和文件核验状态，包括准新比亚迪等车型，并按合规流程安排国际发运。', fr: 'Véhicules d’occasion complets exportés de Chine avec VIN, kilométrage et statut documentaire, dont des BYD récentes, pour expédition internationale conforme.', ar: 'سيارات مستعملة كاملة للتصدير من الصين مع رقم الهيكل والمسافة وحالة مراجعة الوثائق، بما في ذلك سيارات BYD حديثة للشحن الدولي المتوافق.' },
