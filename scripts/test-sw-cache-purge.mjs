...
assert(sw.includes("CACHE_VERSION = 'pwa-app-v6'"), 'CACHE_VERSION is pwa-app-v6');
...
const current = 'pwa-app-v6-static';
const observed = [
...
assert(!toDelete.includes(current), 'keeps current pwa-app-v6-static');
...
assert(installJs.includes("SW_URL = '/sw.js?v=pwa-app-v6'"), 'pwa-install registers sw.js?v=pwa-app-v6');
