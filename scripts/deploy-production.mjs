...
grep -E -q 'half-cut-directory\.js\?v=(category-filter-v1|parts-parallel-v1|stock-id-search-v1|stock-id-search-v2|dedicated-price-v1|catalog-search-v1|catalog-search-v2)' "$PUB/half-cuts/index.html"
grep -E -q 'ebay-catalog-hub\.js\?v=(category-filter-v1|parts-parallel-v1|stock-id-search-v1|stock-id-search-v2|dedicated-price-v1|catalog-search-v1|catalog-search-v2)' "$PUB/half-cuts/index.html"
grep -E -q 'half-cut-directory\.js\?v=(category-filter-v1|stock-id-search-v2|dedicated-price-v1|catalog-search-v1|catalog-search-v2)' "$PUB/gearboxes/index.html"
grep -E -q 'ebay-catalog-hub\.js\?v=(category-filter-v1|stock-id-search-v2|dedicated-price-v1|catalog-search-v1|catalog-search-v2)' "$PUB/gearboxes/index.html"
