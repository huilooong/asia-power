...
grep -E -q 'vehicle-engine-001c|parts-parallel-v1|stock-id-search-v2|catalog-search-v2|youtube-embed-v1|youtube-embed-v2' "$PUB/half-cuts/detail.html"
grep -E -q 'youtube-embed-v[12]' "$PUB/half-cuts/detail.html"
