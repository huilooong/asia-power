...
grep -q 'mnav-drawer' "$PUB/index.html"
grep -E -q 'lang-sync-v2|auth-nav-once-v2|mnav-drawer' "$PUB/index.html"
grep -q 'lang-sync-v2' "$PUB/css/styles.css"
grep -q 'home.v4.hero.title' "$PUB/index.html"
grep -q 'data-ap-auth-slot' "$PUB/index.html"
grep -E -q 'auth-nav-once-v2|mnav-drawer' "$PUB/index.html"
grep -q 'data-mnav-toggle' "$PUB/index.html"
grep -q 'data-mnav-drawer' "$PUB/index.html"
...
grep -q 'pwa-app-v6c' "$PUB/index.html"
grep -q "CACHE_VERSION = 'pwa-app-v6c'" "$PUB/sw.js"
grep -q 'isCatalogDetailNavigation' "$PUB/sw.js"
...
grep -q 'supplier-referral-v1' "$PUB/supplier-portal/dashboard.html"
grep -q '/api/supplier/referral-code' "$PUB/js/supplier-dashboard.js"
...
grep -q 'electrical equipment' "$PUB/llms.txt"
...
grep -E -q 'about-type-v2|mnav-drawer' "$PUB/about.html"
grep -E -q 'about-type-v2|mnav-drawer' "$PUB/contact.html"
grep -q 'ebay-contact-section' "$PUB/css/ebay-layout.css"
grep -q 'max-width: 920px' "$PUB/css/ebay-layout.css"
grep -E -q 'about-type-v2|mnav-drawer' "$PUB/ghana.html"
grep -E -q 'about-type-v2|mnav-drawer' "$PUB/nigeria.html"
grep -E -q 'about-type-v2|mnav-drawer' "$PUB/kenya.html"
grep -E -q 'about-type-v2|mnav-drawer' "$PUB/brands/toyota.html"
...
grep -q 'mnav-drawer' "$PUB/js/components.js"
...
grep -E -q 'about-type-v2|mnav-drawer' "$PUB/half-cuts/index.html"
grep -E -q 'catalog-search-v1|catalog-search-v2|stock-id-search-v[12]' "$PUB/half-cuts/index.html"
grep -E -q 'about-type-v2|mnav-drawer' "$PUB/engines/index.html"
grep -q 'mnav-drawer' "$PUB/engines/ghana-used-engines-from-china.html"
grep -q 'mnav-drawer' "$PUB/engines/toyota-engines-for-ghana-importers.html"
grep -q 'mnav-drawer' "$PUB/engines/nigeria-used-engines-from-china.html"
grep -q 'mnav-drawer' "$PUB/engines/hyundai-kia-engines-for-nigeria-importers.html"
grep -q 'mnav-drawer' "$PUB/guides/index.html"
grep -q 'mnav-drawer' "$PUB/guides/buying-used-engines-from-china.html"
...
# IA markers
grep -q 'supplier-referral-v1' "$PUB/admin/inventory.html"
...
grep -q 'admin-supplier-invites.js?v=supplier-referral-v1' "$PUB/admin/inventory.html"
grep -q '/api/admin/supplier-referrals' "$PUB/js/admin-supplier-invites.js"
...
function deployApsalesOpenClaw() {
  ...
  rsync(
    `${ROOT}/deploy/apsales-live-draft/apsales-inventory-links.mjs`,
    `${REMOTE}:/root/.openclaw/extensions/apsales-live-draft/apsales-inventory-links.mjs`,
  );
  rsync(
...
REUSABLE_EVIDENCE=\$BRIDGE_DIR/apsales-reusable-evidence.mjs
REUSABLE_EVIDENCE_NEXT=\${REUSABLE_EVIDENCE}.next
