...
grep -E -q 'half-cut-directory\\.js\\?v=(category-filter-v1|category-filter-v3|category-filter-v4|parts-parallel-v1|stock-id-search-v1|stock-id-search-v2|dedicated-price-v1|catalog-search-v1|catalog-search-v2|vehicle-engine-001b)' "$PUB/half-cuts/index.html"
grep -E -q 'ebay-catalog-hub\\.js\\?v=(category-filter-v1|category-filter-v3|category-filter-v4|parts-parallel-v1|stock-id-search-v1|stock-id-search-v2|dedicated-price-v1|catalog-search-v1|catalog-search-v2|vehicle-engine-001b)' "$PUB/half-cuts/index.html"
grep -E -q 'half-cut-directory\\.js\\?v=(category-filter-v1|category-filter-v3|category-filter-v4|stock-id-search-v2|dedicated-price-v1|catalog-search-v1|catalog-search-v2|vehicle-engine-001b)' "$PUB/gearboxes/index.html"
grep -E -q 'ebay-catalog-hub\\.js\\?v=(category-filter-v1|category-filter-v3|category-filter-v4|stock-id-search-v2|dedicated-price-v1|catalog-search-v1|catalog-search-v2|vehicle-engine-001b)' "$PUB/gearboxes/index.html"
grep -E -q 'catalog-search-v1|catalog-search-v2|stock-id-search-v[12]|vehicle-engine-001b' "$PUB/half-cuts/index.html"
...
grep -E -q 'vehicle-engine-001b|parts-parallel-v1|stock-id-search-v2|catalog-search-v2' "$PUB/half-cuts/detail.html"
