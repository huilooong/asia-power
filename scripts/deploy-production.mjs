...
grep -E -q 'half-cut-directory\.js\?v=(parts-parallel-v1|stock-id-search-v1|stock-id-search-v2|dedicated-price-v1|catalog-search-v1|catalog-search-v2|jac-s3-mistag-v1)' "$PUB/half-cuts/index.html"
grep -E -q 'ebay-catalog-hub\.js\?v=(parts-parallel-v1|stock-id-search-v1|stock-id-search-v2|dedicated-price-v1|catalog-search-v1|catalog-search-v2|jac-s3-mistag-v1)' "$PUB/half-cuts/index.html"
grep -E -q 'half-cut-directory\.js\?v=(stock-id-search-v2|dedicated-price-v1|catalog-search-v1|catalog-search-v2|jac-s3-mistag-v1)' "$PUB/gearboxes/index.html"
grep -E -q 'ebay-catalog-hub\.js\?v=(stock-id-search-v2|dedicated-price-v1|catalog-search-v1|catalog-search-v2|jac-s3-mistag-v1)' "$PUB/gearboxes/index.html"
grep -E -q 'catalog-search-v1|catalog-search-v2|stock-id-search-v[12]|jac-s3-mistag-v1' "$PUB/half-cuts/index.html"
...
grep -E -q 'catalog-search-v1|catalog-search-v2|stock-id-search-v[12]|dedicated-price-v1|jac-s3-mistag-v1' "$PUB/engines/index.html"
