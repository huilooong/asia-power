...
export const TARGET_SOURCE_FILES = {
  ...
  'apsales-openclaw': [
    ...
    'deploy/apsales-live-draft/apsales-reasoning-policy.mjs',
...
export const TARGET_REMOTE_PATHS = {
  ...
  'apsales-openclaw': [
    ...
    '/root/.openclaw/extensions/apsales-live-draft/apsales-human-visibility.mjs',
    ...
    '/root/.openclaw/extensions/apsales-live-draft/apsales-reasoning-policy.mjs',
