...
export const TARGET_SOURCE_FILES = {
  ...
  apsales: [
    ...
    'scripts/apbd_leads_ca_batch.py',
    'scripts/apbd_leads_ca_trickle.py',
    ...
    'config/apbd_leads_markets.yaml',
    'config/apbd_lead_keywords.yaml',
    'config/apbd_lead_scoring.yaml',
    'agents/apbd',
  ],
  'apsales-openclaw': [
...
export const TARGET_REMOTE_PATHS = {
  ...
  portal: [
    ...
    '/root/.openclaw/workspace/inventory-site/public/supplier-portal/export-used-car-upload.html',
    '/root/.openclaw/workspace/inventory-site/public/supplier-portal.html',
  ],
  chrome: [
    '/root/.openclaw/workspace/inventory-site/public/index.html',
    '/root/.openclaw/workspace/inventory-site/public/css/sitewide-secondary-v1.css',
    '/root/.openclaw/workspace/inventory-site/public/js/components.js',
    ...
    '/root/.openclaw/workspace/inventory-site/public/js/path-utils.js',
    ...
    '/root/.openclaw/workspace/inventory-site/public/js/half-cut-vehicle-title-i18n.js',
    '/root/.openclaw/workspace/inventory-site/public/js/powertrain-image-catalog.js',
    '/root/.openclaw/workspace/inventory-site/public/js/engine-card-label.js',
    '/root/.openclaw/workspace/inventory-site/public/js/half-cut-detail.js',
    '/root/.openclaw/workspace/inventory-site/public/js/half-cut-catalog.js',
    '/root/.openclaw/workspace/inventory-site/public/js/ebay-catalog-hub.js',
    '/root/.openclaw/workspace/inventory-site/public/js/brand-page.js',
    '/root/.openclaw/workspace/inventory-site/public/js/quote-list.js',
    ...
    '/root/.openclaw/workspace/inventory-site/public/engines',
    '/root/.openclaw/workspace/inventory-site/public/brands',
    '/root/.openclaw/workspace/inventory-site/public/gearboxes/index.html',
    '/root/.openclaw/workspace/inventory-site/public/front-cuts/index.html',
    '/root/.openclaw/workspace/inventory-site/public/chassis-parts/index.html',
    '/root/.openclaw/workspace/inventory-site/public/truck-heads/index.html',
    '/root/.openclaw/workspace/inventory-site/public/tires/index.html',
    ...
    '/root/.openclaw/workspace/inventory-site/public/privacy.html',
    '/root/.openclaw/workspace/inventory-site/public/ghana.html',
    '/root/.openclaw/workspace/inventory-site/public/nigeria.html',
    '/root/.openclaw/workspace/inventory-site/public/kenya.html',
    '/root/.openclaw/workspace/inventory-site/public/brands.html',
    '/root/.openclaw/workspace/inventory-site/public/quote-list.html',
    '/root/.openclaw/workspace/inventory-site/public/app.html',
    '/root/.openclaw/workspace/inventory-site/public/supplier-portal.html',
    '/root/.openclaw/workspace/inventory-site/public/supplier-portal/export-used-car-upload.html',
    '/root/.openclaw/workspace/inventory-site/public/supplier-portal/half-cut-upload.html',
    '/root/.openclaw/workspace/inventory-site/public/supplier-portal/passenger-parts-upload.html',
    '/root/.openclaw/workspace/inventory-site/public/supplier-portal/truck-upload.html',
    '/root/.openclaw/workspace/inventory-site/public/supplier-portal/truck-vehicle-upload.html',
    ...
    '/root/.openclaw/workspace/inventory-site/public/campaigns/truck-export/index.html',
  ...
  admin: [
    ...
    '/root/.openclaw/workspace/inventory-site/public/js/admin-supplier-invites.js',
  ...
  apsales: [
    ...
    '/root/.openclaw/workspace/AsiaPower/config/apbd_leads_markets.yaml',
    '/root/.openclaw/workspace/AsiaPower/config/apbd_lead_keywords.yaml',
