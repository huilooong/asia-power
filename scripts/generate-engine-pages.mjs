    ...
    <section class="engine-hero">
      <div class="container">
        ...
        <div class="hero-grid">
          ...
          <aside class="quick-card"><h2>${esc(record.code)} quote path</h2><p>${esc(copy.cta)}</p><a class="btn btn-whatsapp" href="https://wa.me/8616638801930?text=${waText}" target="_blank" rel="noopener noreferrer">WhatsApp ${esc(record.code)}</a><a class="btn btn-outline" href="#inquiry">Send enquiry</a></aside>
        </div>
      </div>
    </section>
